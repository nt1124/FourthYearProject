...
struct Circuit *checkCircuitFromRaw(struct RawCircuit *rawInputCircuit)
{
	struct gateOrWire *tempGateOrWire;
	struct gateOrWire **gatesList;
...
struct Circuit *checkCircuitFromRawSeeded(struct RawCircuit *rawInputCircuit, unsigned int seed, 
										mpz_t secret_input,
										struct public_builderPRS_Keys *public_inputs,
										int j, struct eccParams *params)
{
