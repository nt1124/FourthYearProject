		...
		\subsection{Progress so far}
			...
			\begin{figure}[h!]
				...
				\begin{tabular}[!htb]{r | c | c}
					\textbf{Part of Implementation} & \textbf{CPU time} & \textbf{Wall clock time}\\
					\hline
					\textbf{Building party} & & \\
					Building Circuit & $0.180$ & $0.187$\\
					Sending circuit & $\sim 0.01$ & $0.043$\\
					OT &  $0.668$ & $0.897$\\

					\hline
					\textbf{Executing party} & & \\
					Receiving Circuit &  $\sim 0.02$ &  $0.059$\\
					OT & $0.316$ & $0.965$ \\
					Circuit Evaluation & $0.0160$ & $0.017$\\
			...
			Most of this time is spent on the Oblivious Transfers, moreover the computational workload seems to be heavily weighted towards the Building party.
