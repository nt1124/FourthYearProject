...
% 
	...
	\chapter{Experiments} \label{sec:Results}
		...
		\section{Results}
			...
			\subsection{32-bit addition}
				\FloatBarrier
				\noindent \textbf{Lindell-Pinkas 2010}
				\begin{figure}[!ht]
				...
				\FloatBarrier
				\noindent \textbf{Huang-Katz-Evans 2013}
				\begin{figure}[!ht]
					\begin{tabular}{| p{4.3cm} | c c c c |}
						\hline
			...
			\subsection{32-bit multiplication}
				...
				\FloatBarrier
				\noindent \textbf{Huang, Katz and Evans 2013}
				\begin{figure}[!ht]
					\begin{tabular}{| p{4.3cm} | c c c c |}
						\hline
						 & \textbf{CPU Time} & \textbf{Wall Time} & \textbf{Bytes Sent} & \textbf{Bytes Recv} \\
