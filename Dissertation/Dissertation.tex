	...
	\chapter{Protocols} \label{sec:Protocols}
		...
		\section{Huang, Katz and Evans 2013}
			...
			\subsection{Consistency of party's inputs}
				...
				Huang et al. propose that when building their circuits each party make their input keys be of the form
...
% 				$$v_i = \bigg\{	\begin{matrix}
% 							g^k, & x_k = 0\\
% 							C / g^k, & x_k = 1
% 						\end{matrix}$$
% 
% 				, in the HKE protocol the party building a circuit generates their input keys to be of the form.\\
% 
% 
% 				$$v_i = \bigg\{	\begin{matrix}
% 							g^{a_0^i}, & x_k = 0\\
