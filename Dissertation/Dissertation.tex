...
% 				\end{figure}
		...
		\section{Results}
			...
			\subsection{32-bit addition}
				...
				We expected to see a poor showing from the Lindell 2013 protocol due to the circuits small size. Addition and Multiplication are both fairly silly examples for Secure Two Party computation as the functions completely leak the other party's input to each party. 
