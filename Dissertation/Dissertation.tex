	...
	\chapter{Protocols} \label{sec:Protocols}
		\section{Lindell and Pinkas 2011}
			\subsection*{Overview}
				...
				The Executor can then reveal for which circuit it received all inputs.\\

				Clearly this requires that the Executing party be able to prove that only $\frac{s}{2}$ many of the CRSs allow the recovery of both inputs. This is achieved via a Zero Knowledge Proof detailed in Appendix B of \cite{LindellAndPinkas2011} which also uses a secret sharing scheme.
