	...
	\chapter{Technical Background}
		\section{Oblivious Transfer} \label{sec:OT_Intro}
			...
			\subsection{Peikert - Vaikuntanathan - Waters Oblivious Transfer} \label{sub:dualModeCryptoOT}
				...
				\subsubsection{Dual-Mode cryptosystem}
					\textcolor{red}{The Dual-mode cryptosystem has two modes (\emph{messy} and \emph{decryption}), selected during the setup, a Common Reference String(CRS) is also generated at setup. The Receiver uses their input bit and the CRS to generate a ``base'' public key and private key.}\\
