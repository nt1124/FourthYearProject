			...
			\subsection{AES encryption}
				...
				\begin{figure}[!ht]
					...
					\begin{tabular}{| p{3.5cm} | c c c c |}
						...
						\hline
					\end{tabular}
					\caption{This table shows the performance of the Huang-Katz-Evans 2013 protocol evaluating the AES encryption circuit averaged over 100 trials.\label{table:HKE_2013_AES}}
				\end{figure}
