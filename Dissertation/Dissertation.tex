...
% 	\end{titlepage}
	...
	\chapter{Implementation Details} \label{sec:ImplementationDetails}
		...
		\subsubsection{Secret Sharing and Multi-precision Polynomials}
			...
			Consider a polynomial K of degree n. Then we can denote this polynomial as $K = \sum{i=0}{n} a_i \cdot x ^ i$. Any such polynomial of degree $n$ can be uniquely defined given $n+1$ (or more) points on the curve, given fewer points then this 
