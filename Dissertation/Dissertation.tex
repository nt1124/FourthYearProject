...
\begin{document}
	...
	\chapter{Protocols} \label{sec:Protocols}
		...
		\section{Huang, Katz and Evans 2013}
			...
			The probability of a malicious adversary successfully cheating is $2^{-s + log(s)}$ where $s$ is the number of circuits created by \emph{each} party. Note this means that we actually need to create $2s$ many circuits, however the protocol is symmetrical, both parties need to do the same amount of work. Huang et al. claim that due to the symmetrical nature of the protocol.
