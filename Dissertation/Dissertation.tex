			...
			\subsection{32-bit addition}
				...
				\begin{figure}[!h]
					...
					\begin{center}
						...
						\end{tabular}
					\end{center}
					\caption{These tables show the performance of the Lindell-Pinkas 2010 protocol evaluating the 32-bit addition circuit averaged over 100 trials. Note how uneven the computational load is between the Builder and the Executor, this is a general trend with this protocol. \label{table:LP_2010_addition}}
				\end{figure}
