...
% 					\hline
% 					\hline
% 					$0$ & $1$ & $E_{k_0^0}(E_{k_1^0}(k_2^0 \Vert \pi_i(0)))$\\
% 					\hline
% 					$0$ & $0$ & $E_{k_0^0}(E_{k_1^1}(k_2^0 \Vert \pi_i(0)))$\\
% 					\hline
% 					$1$ & $1$ & $E_{k_0^1}(E_{k_1^0}(k_2^0 \Vert \pi_i(0)))$\\
% 					\hline
% 					$1$ & $0$ & $E_{k_0^1}(E_{k_1^1}(k_2^1 \Vert \pi_i(1)))$\\
% 				\end{tabular}
% 			\end{column}
% 		\end{columns}
% 
